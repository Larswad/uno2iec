...
#define DEFAULT_ATN_PIN   D0  // IO16
#define DEFAULT_CLOCK_PIN D5  // IO14
#define DEFAULT_DATA_PIN  D6  // IO12
#define DEFAULT_SRQIN_PIN D7  // IO13
#define DEFAULT_RESET_PIN D8  // IO15
...
void IEC::testOUTPUTS()
{
	...
	if(now - m_lastMillis >= 3000) {
		m_lastMillis = now;
		char buffer[80];
		sprintf(buffer, "Lines: CLOCK: %s DATA: %s\r\n", (lowOrHigh ? "HIGH" : "LOW"), (lowOrHigh ? "HIGH" : "LOW"));
		Log(Information, FAC_IEC, buffer);
