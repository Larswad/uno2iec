...
const ushort C64_BASIC_START = 0x0801;
...
private:
	...
	uchar m_interfaceState; // see InterfaceState
	// This var is set after an open command and determines what to send next
	uchar m_openState;			// see OpenState
	...
	void sendLineCallback(short lineNo, uchar len, char* text);

	// send listing pointer in basic memory:
	volatile ushort m_basicPtr;
};
